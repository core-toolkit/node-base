...
describe('__name__UseCase', () => {
  describe('.getAll()', () => {
    it('fetches a list of all __name__ entries', async () => {
      const mock = jest.fn();
      const useCase = __name__UseCase({ Model: { __name__: { findAll: mock } } });
  ...
  describe('.getById()', () => {
    it('fetches a single __nameLower__', async () => {
      const mock = jest.fn();
      const useCase = __name__UseCase({ Model: { __name__: { findByPk: mock } } });
  ...
  describe('.create()', () => {
    it('creates a __nameLower__', async () => {
      const mock = jest.fn();
      const useCase = __name__UseCase({ Model: { __name__: { create: mock } } });
